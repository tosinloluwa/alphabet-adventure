...
class MonitoringNamespace extends namespace_1.Namespace {
    ...
    async getCommands() {
        return new namespace_1.CommandMap([
            ['syncmaps', async () => { const { MonitoringSyncSourcemapsCommand } = await Promise.resolve().then(() => __importStar(require('./syncmaps'))); return new MonitoringSyncSourcemapsCommand(this); }],
        ]);
    }
}
